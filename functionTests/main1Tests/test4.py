...
try:
    res = tfun._T_funhddc_main1(datam, Wlist, K, df_start, 'numeric', 'yes', 'AKJBKQKDK', itermax, threshold, 'cattell', 1.e-6, 'kmeans', None, None, 0, noise, None, kmeans_control, d_max, d_set, None)
    print(res.a)
    print(res.b)
    print(res.nux)
    print(res.converged)
