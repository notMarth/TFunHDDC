...
while j < itTest:
    ...
    res = tfun._T_funhddc_main1(fd, Wlist, K, df_start, 'numeric', 'yes', 'AKJBKQKDK', itermax, threshold, 'cattell', 1.e-6, 'vector', vec, None, 2, noise, None, None, d_max, d_set, None)
...
filename = 'VectorNumericCattellYes.csv'
...
filename = 'VectorNumericCattellYesKnown.csv'
with open(filename, 'w', newline='') as csvfile:
    datawriter = csv.writer(csvfile)
