...
df_start = 50.
itermax = 200
vec = np.repeat(2, len(datam.coefficients))
vec[0:50] = 0
vec[50:100] = 1
try:
    res = tfun._T_funhddc_main1(datam, Wlist, K, df_start, 'numeric', 'yes', 'AKJBKQKDK', itermax, threshold, 'bic', 1.e-6, 'vector', vec, None, 0, noise, None, None, d_max, d_set, None)
