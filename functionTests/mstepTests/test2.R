...
initx = .T_funhddt_init(a, Wlist, K, t, nux, "AKJBKQKDK", threshold, "cattell", noise, NULL, d_max, d_set)
tw = TFunHDDC:::.T_funhddt_twinit(a, Wlist, initx, nux)

m = TFunHDDC:::.T_funhddt_m_step1(a, Wlist, K, t, tw, nux, 'numeric', 'yes', 'AKJBKQKDK', threshold, 'cattell', noise, NULL, d_max, d_set)