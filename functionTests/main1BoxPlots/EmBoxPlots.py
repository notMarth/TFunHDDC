...
axs[0,0].set_title('BIC for Mini-em init without Known')

axs[0, 1].boxplot(stats1['icl'])
axs[0,1].set_title('ICL for Mini-em init without Known')

axs[1,0].boxplot(stats2['bic'])
axs[1,0].set_title('BIC for Mini-em init with Known')

axs[1,1].boxplot(stats2['icl'])
axs[1,1].set_title('ICL for Mini-em init with Known')
