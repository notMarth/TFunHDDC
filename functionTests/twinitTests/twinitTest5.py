...
par = {'K': 3, 'nux':np.array([2.,2,2]), 'a': a, 'b': np.array([4.e44, 5e67, 2.3e30]), 'd':np.array([3,2,2.]), 'mu':mu, 'prop': np.array([1/3,1/3,1/3]), 'Q':Q, 'Q1':Q1}
...
with open('twinitTest5Res.csv', 'w', newline='') as csvfile:
