...
a = np.zeros((3,3))
a[0] = np.array([5.e67, 1e55, 6e32])
a[1] = np.array([7.5e23, 8.9e56, None])
a[2] = np.array([7e44, 1.2e43, None])

par = {'K': 3, 'nux':np.array([2.,2,2]), 'a': a, 'b': np.array([4e44,5e67,2.3e30]), 'd':np.array([3,2,2.]), 'mu':mu, 'prop': np.array([1/3,1/3,1/3]), 'Q':Q, 'Q1':Q1}
...
with open('twinitTest2Res.csv', 'w', newline='') as csvfile:
