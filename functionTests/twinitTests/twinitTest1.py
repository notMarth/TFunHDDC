...
a = np.zeros((3,3))
a[0] = np.array([5., 1, 6])
a[1] = np.array([7.5, 8.9, None])
a[2] = np.array([7, 1.2, None])

par = {'K': 3, 'nux':np.array([2.,2,2]), 'a': a, 'b': np.array([4,5,2.3]), 'd':np.array([3,2,2.]), 'mu':mu, 'prop': np.array([1/3,1/3,1/3]), 'Q':Q, 'Q1':Q1}
