...
a
a[1,]=c(5e-60, 1e-52, 6e-64)
a[2,]=c(7.5e-33, 7.9e-46, NA)
a[3,]=c(7e-24, 3.2e-53, NA)
a
par=list(K=3,nux=c(2,2,2),a=a, b=c(3.2e-44,7.2e-60,1e-50), d=c(3,2,2),mu=mu,prop=c(1/3,1/3,1/3),
         Q=Q,Q1=Q1)
