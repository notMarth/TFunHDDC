...
while j < itTest:
    print(j)
    try:
        res = tfun._T_funhddc_main1(fd, Wlist, K, df_start, 'numeric', 'yes', 'AKJBKQKDK', itermax, threshold, 'cattell', 1.e-6, 'kmeans', None, None, 2, noise, None, kmeans_control, d_max, d_set, None, 'yes')
